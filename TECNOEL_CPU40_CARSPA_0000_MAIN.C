...
#define DCON_DCNO03  0x0136  // Modulo DCON 03 - 7043 - Valore Uscite
#define DCON_DCNO04  0x0137  // Modulo DCON 04 - 7050 - Valore Uscite
#define DCON_DCNO50  0x0138  // Modulo DCON 05 - 7017 - Valore Ingresso Analogico 0
#define DCON_DCNO51  0x0139  // Modulo DCON 05 - 7017 - Valore Ingresso Analogico 1
#define DCON_DCNO52  0x013A  // Modulo DCON 05 - 7017 - Valore Ingresso Analogico 2
#define DCON_DCNO53  0x013B  // Modulo DCON 05 - 7017 - Valore Ingresso Analogico 3
#define DCON_DCNO54  0x013C  // Modulo DCON 05 - 7017 - Valore Ingresso Analogico 4
#define DCON_DCNO55  0x013D  // Modulo DCON 05 - 7017 - Valore Ingresso Analogico 5
#define DCON_DCNO56  0x013E  // Modulo DCON 05 - 7017 - Valore Ingresso Analogico 6
#define DCON_DCNO57  0x013F  // Modulo DCON 05 - 7017 - Valore Ingresso Analogico 7
#define DCON_DCNO60  0x0140  // Modulo DCON 06 - 7024 - Valore Uscita Analogica 0 (0 ... 10.000 = Positivi 10.001 20.000 Negativi)
#define DCON_DCNO61  0x0141  // Modulo DCON 06 - 7024 - Valore Uscita Analogica 1 (0 ... 10.000 = Positivi 10.001 20.000 Negativi)
#define DCON_DCNO62  0x0142  // Modulo DCON 06 - 7024 - Valore Uscita Analogica 2 (0 ... 10.000 = Positivi 10.001 20.000 Negativi)
#define DCON_DCNO63  0x0143  // Modulo DCON 06 - 7024 - Valore Uscita Analogica 3 (0 ... 10.000 = Positivi 10.001 20.000 Negativi)
...
// LPS
#define LPS_POSITION  	 	0x014B  // Posizione inerziale 			espressa in step (buchi letti dall'encoder)
...
#use "TECNOEL_CPU40_DCONV00_0100.LIB"
...
main()
{
   ...
   BiosIOSetBitReg(DCON_CNFPRE,5,1);
   BiosIOSetBitReg(DCON_CNFPRE,6,1);
   ...
   // *************************************************************************
  	...
  	//DEBUG PER SIMULARE MARCIA INDIETRO
  	Set_ENGINE_VERSUS(0);
